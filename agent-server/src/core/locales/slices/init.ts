...
export const initEn = {
  ...
  'init.service.systemdUserEnableHint': 'To enable: sudo systemctl --user enable --now cortex',
  ...
  'init.gatewaySetup.preservedModesHint': 'If these should have been auto-detected, check `pi /login` / `pi --list-models` and re-run.',
...
export const initZh: Record<keyof typeof initEn, string> = {
  ...
  'init.service.systemdUserEnableHint': '启用方法：sudo systemctl --user enable --now cortex',
  ...
  'init.gatewaySetup.preservedModesHint': '如果这些本应被自动检测到，请检查 `pi /login` / `pi --list-models` 后重新运行。',
