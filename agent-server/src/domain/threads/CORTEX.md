...
| `state-machine.ts` | state machine | createThread / addAgentToThread / resolveNextStep / evaluateTransitions / recordStepResult / completeThread / failThread / cancelThread / abortThread / detectAbortMarker / detectWaitMarker / tryEnterWaiting (thread + task children, §8) / detectSplitMarker (DR-0014) |
